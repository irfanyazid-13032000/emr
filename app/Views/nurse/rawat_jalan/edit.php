          ...
          <td width='30%'>
            <select name="tujuan" id="tujuan" style="width:250px">
              <?php foreach ($tujuan as $tuju) : ?>
                <?php if ($tuju['FS_NM_DIAGNOSA'] === $masalah['FS_NM_MASALAH_KEP']) : ?>
                  <option value="<?= $masalah['FS_KD_MASALAH_KEP'] ?>" selected><?= $masalah['FS_NM_MASALAH_KEP'] ?></option>
                <?php else : ?>
          ...
          <td width='30%'>
            <select name="tembusan" id="tembusan" style="width:250px">
              <?php foreach ($tembusan as $tembus) : ?>
                <?php if ($tembus['FS_NM_REN_KEP'] === $rencana['FS_NM_REN_KEP']) : ?>
                  <option value="<?= $rencana['FS_KD_REN_KEP'] ?>" selected><?= $rencana['FS_NM_REN_KEP']; ?></option>
                <?php else : ?>
