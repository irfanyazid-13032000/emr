  ...
  <table class="table-view" width="100%">
    ...
    <tbody>
      <?php foreach ($rs_pasien as $data) : ?>
        ...
        <?php $cek_lab = $this->m_rawat_jalan->cek_data_order_lab_by_rg2(array($data['FS_KD_REG'])); ?>
        <?php $cek_rad = $this->m_rawat_jalan->cek_data_order_rad_by_rg2(array($data['FS_KD_REG'])); ?>
