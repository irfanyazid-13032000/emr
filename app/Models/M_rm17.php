 ...
 WHERE      aa.fs_kd_reg = ?";
    ...
    function get_rm17det_by_rg_all($params) {
        $sql = "SELECT a.*,b.*,c.FS_NM_PEG,d.FS_NM_PEG 'FS_NM_PEG2',e.FS_NM_PEG 'FS_NM_PEG3' 
                ...
                LEFT JOIN HOSPITAL.dbo.TD_PEG c ON b.FS_KD_PEG=c.FS_KD_PEG
                LEFT JOIN HOSPITAL.dbo.TD_PEG d ON b.FS_KD_PEG2=d.FS_KD_PEG
                LEFT JOIN HOSPITAL.dbo.TD_PEG e ON b.FS_KD_PEG3=e.FS_KD_PEG
